...
tsne_plot
ggsave(filename = "plot_2d/tsne_plot.png", width = 9, height = 9)
ggsave(filename = "plot_2d/tsne_plot.pdf", width = 9, height = 9)
...
str_plot <- structure_plot(fit,colors = topic_colors,topics = 1:6,gap = 25,
                           grouping = samples)
str_plot
ggsave(filename = "plot_2d/structure_plot.png", width = 9, height = 9)
ggsave(filename = "plot_2d/structure_plot.pdf", width = 9, height = 9)
...
saveWidget(fig, "plot_3d/3dscatterplot.html", selfcontained = TRUE, title = "fastTopics in 3D")
